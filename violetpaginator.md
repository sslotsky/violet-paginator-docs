...
This is a fully featured pagination component. It includes link for the previous and next page, for the first and last page, and for up to three specific page links on each side of the current page. The example below shows the component on page 6 of 35. 
